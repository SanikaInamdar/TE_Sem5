...
class Pass1:
    ...
    def process(self):
        with open("/Users/sanikainamdar/Desktop/LP1/A1_AssemblerPass1/pass1c.txt", "r") as file:
            data = file.readlines()
            for line in data:
                word = line.replace('\n', '').split('\t')
        ...
        with open("/Users/sanikainamdar/Desktop/LP1/A1_AssemblerPass1/STAB.txt", "w") as file:
            str1 = ""
        ...
        with open("/Users/sanikainamdar/Desktop/LP1/A1_AssemblerPass1/LTAB.txt", "w") as file:
            str1 = ""
        ...
        with open("/Users/sanikainamdar/Desktop/LP1/A1_AssemblerPass1/PTAB.txt", "w") as file:
            str1 = ""
